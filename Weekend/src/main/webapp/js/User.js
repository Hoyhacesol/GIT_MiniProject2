...
function emailCheck() {
    ...
    window.open(url, "_blank_1", "toolbar=no, menubar=no, scrollbars=yes, resizable=no, width=450, height=250, left=700, top=300");
}
...
function nicknameCheck() {
	...
	window.open(url, "_blank_1",
					"toolbar=no, menubar=no, scrollbars=yes, resizable=no, width=450, height=250, left=700, top=300");
}
